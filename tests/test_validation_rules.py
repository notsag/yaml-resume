...
DOB = {
    ...
    "not_valid": ["01/13/90", "01/10/90", "40/10/1990", "10/40/1990"],
}

EMAILS = {
    "valid": ["john@doe.com", "john.doe@johndoe.com", "john@doe.co.uk"],
    "not_valid": ["johndoe.com", "john.doe@johndoe"],
}

URLS = {
    "valid": ["http://sbook.com/johndoe", "https://sbook.com/johndoe"],
    "not_valid": ["sbook.com/johndoe", "ftp://sbook.com/johndoe"],
}
...
PHONE_NUMBERS = {
    ...
    "not_valid": ["000", "a0000000", "00 00 00"],
}
